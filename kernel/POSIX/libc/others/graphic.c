...
/* 
 * $Log: graphic.c,v $
 * Revision 1.1.1.1  2003/02/05 03:57:15  monaka
 * From eota-0.3.4.tgz
 *
 ...
 *
 */
/* $Id: graphic.c,v 1.1.1.1 2003/02/05 03:57:15 monaka Exp $ */

static char rcsid[] =
    "$Header: /Users/tonpa/Downloads/b-free/b-free/kernel/POSIX/libc/others/graphic.c,v 1.1.1.1 2003/02/05 03:57:15 monaka Exp $";
...
int set_background(int fd, int width, int height, unsigned char *bitmap, int color, int bgcolor)
{
...
int set_bitmap(int fd, int x, int y, int width, int height, int size,
...
int spl_bitmap(int fd, int x, int y, int width, int height, int size,
...
int scroll_vga(int fd, int direc, int x, int y, int width, int height,
	       int step, int color)
{

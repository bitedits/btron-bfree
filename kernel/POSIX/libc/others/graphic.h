...
extern int box_vga (int fd, int x, int y, int width, int height,
		    int color, int mode);
extern int fillbox_vga (int fd, int x, int y,
			int width, int height, int color, int mode);
extern int circle_vga (int fd, int x, int y, int width, int height,
		       int color, int mode);
...
extern int set_background (int fd, int width, int height,
			   unsigned char *bitmap, int color, int bgcolor);

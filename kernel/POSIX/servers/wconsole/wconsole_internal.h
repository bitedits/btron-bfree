...
*/
/* $Header: /Users/tonpa/Downloads/b-free/b-free/kernel/POSIX/servers/wconsole/wconsole_internal.h,v 1.1.1.1 2003/02/05 03:57:21 monaka Exp $ */
...
#define VGA16_BLACK	0
#define VGA16_DGRAY	7
#define VGA16_LGRAY	8
#define VGA16_WHITE	15
...
extern W    	control_wconsole(ID caller, ID tskid, DDEV_CTL_REQ *packet);	/* コントロール		*/
...
extern void goto_cursor (W x, W y, W winid);

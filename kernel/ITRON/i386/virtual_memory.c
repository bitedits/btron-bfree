...
*/
/* @(#)$Header: /Users/tonpa/Downloads/b-free/b-free/kernel/ITRON/i386/virtual_memory.c,v 1.1.1.1 2003/02/05 03:57:11 monaka Exp $ */
static char rcsid[] =
    "@(#)$Header: /Users/tonpa/Downloads/b-free/b-free/kernel/ITRON/i386/virtual_memory.c,v 1.1.1.1 2003/02/05 03:57:11 monaka Exp $";
     ...
     */
{
    ...
    size = PAGES(size);
    start = (VP) CUTDOWN((UW) start, PAGE_SIZE);
    if (pmemfree() < size)
	return (E_NOMEM);
    res = E_OK;

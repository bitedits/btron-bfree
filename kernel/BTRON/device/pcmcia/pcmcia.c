...
*/
/* @(#)$Header: /Users/tonpa/Downloads/b-free/b-free/kernel/BTRON/device/pcmcia/pcmcia.c,v 1.1.1.1 2003/02/05 03:56:55 monaka Exp $*/
static char rcs[] = "@(#)$Header: /Users/tonpa/Downloads/b-free/b-free/kernel/BTRON/device/pcmcia/pcmcia.c,v 1.1.1.1 2003/02/05 03:56:55 monaka Exp $";
...
init_driver (void)
{
  ...
  if (recvport <= 0)
    {
      dbg_printf ("pcmcia: cannot make receive porrt.\n");
      slp_tsk ();
      /* メッセージバッファ生成に失敗 */
    }

...
*/
/* @(#)$Header: /Users/tonpa/Downloads/b-free/b-free/kernel/BTRON/device/keyboard/misc.c,v 1.1.1.1 2003/02/05 03:56:55 monaka Exp $ */
static char rcsid[] =
    "@(#)$Header: /Users/tonpa/Downloads/b-free/b-free/kernel/BTRON/device/keyboard/misc.c,v 1.1.1.1 2003/02/05 03:56:55 monaka Exp $";
...
W read_key(W mode)
{
    ...
    if ((! (mode & WAITMODE)) && (current.first == NULL)) {
	return (NULL);
    }

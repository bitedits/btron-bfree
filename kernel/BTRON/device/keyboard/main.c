...
*/
/* @(#)$Header: /Users/tonpa/Downloads/b-free/b-free/kernel/BTRON/device/keyboard/main.c,v 1.1.1.1 2003/02/05 03:56:55 monaka Exp $ */
static char rcsid[] =
    "@(#)$Header: /Users/tonpa/Downloads/b-free/b-free/kernel/BTRON/device/keyboard/main.c,v 1.1.1.1 2003/02/05 03:56:55 monaka Exp $";
...
W control_keyboard(ID caller, ID tskid, DDEV_CTL_REQ * packet)
{
    ...
    case KEYBOARD_GETMODE:
        vput_reg(tskid, (VP)((W *) packet->param)[0], sizeof(W), &driver_mode);
        respond_ctrl(caller, packet->dd, E_OK);
	return (E_OK);

...
/* $Id: command.c,v 1.1.1.1 2003/02/05 03:56:57 monaka Exp $ */
char rcsid[] = "$Id: command.c,v 1.1.1.1 2003/02/05 03:56:57 monaka Exp $";

/*
 * $Log: command.c,v $
 * Revision 1.1.1.1  2003/02/05 03:56:57  monaka
 * From eota-0.3.4.tgz
 *

 ...
 *
 * $Header: /Users/tonpa/Downloads/b-free/b-free/boot/2nd/fd.c,v 1.1.1.1 2003/02/05 03:56:49 monaka Exp $
 *
 * $Log: fd.c,v $
 * Revision 1.1.1.1  2003/02/05 03:56:49  monaka
 * From eota-0.3.4.tgz
 *
...
static char	rcsid[] = "$Header: /Users/tonpa/Downloads/b-free/b-free/boot/2nd/fd.c,v 1.1.1.1 2003/02/05 03:56:49 monaka Exp $";
	 ...
	 BYTE *buff)
{
  ...
  for (readcount = 0; readcount < (BLOCK_SIZE / HD_LENGTH); readcount++, blockno++, buff += HD_LENGTH)
      ...
      for (i = 0; i < MAX_RETRY; i++)
	{
      ...
      if (i >= MAX_RETRY)
	{
	  boot_printf ("Read failed. %d [%d %d %d]\n",
		       blockno, head, cylinder, sector);
	  stop_motor (0);
	  while(1);
	}
    }
